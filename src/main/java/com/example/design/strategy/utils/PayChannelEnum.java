 ...
 */
package com.example.design.strategy.utils;
...
public enum PayChannelEnum {
    ...
    //支付
    ALIPAY("aliPayStrategy","支付宝通道"),
    YINLIAN("yinLianPayStrategy","银联通道");
    ...
    private PayChannelEnum(String way, String desc) {
        this.desc = desc;
        this.way = way;
    }
    ...
    public static void main(String[] args){
        System.out.println(PayChannelEnum.ALIPAY.getWay());
        System.out.println(getEnum("ALIPAY"));
    }
